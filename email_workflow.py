...
def generate_email_content(prompt):
    ...
    try:
        ...
        logging.info("Email content generated by LLM.")
...
def modify_email_content(original_email, suggestions):
    ...
    try:
        ...
        logging.info("Email content modified by LLM.")
    except Exception as e:
        logging.error(f"Error modifying email content: {e}")
...
def Auto_emailing():
    ...
    while True:
        ...
        user_choice = input("Enter 'yes' to send, 'change' to modify, or 'cancel' to abort: ").strip().lower()
        ...
        if user_choice == 'yes':
            ...
            suggestions = input("Enter your suggestions for changes: ")
            subject, body, full_email = modify_email_content(full_email, suggestions)
        
        elif user_choice == 'cancel':
            print("Email workflow cancelled.")
            break
